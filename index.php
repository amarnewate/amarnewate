            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-lg-12">
                        ...
                        <span class="text-primary float-right  ">Buy And Sell Property</span><br>
                                 <span> </h1>
                        <h1 class="mb-4"><span class="text-primary">Find</span><br>
                                Your dream house</h1> <h1 class="mb-4">
                            <form method="post" action="propertygrid.php">
                                <div class="row">
                                    ...
                                    <div class="form-group">
        <input type="text" class="form-control" name="location" placeholder="Enter City or State" required>
    </div>
                                    </div>
                        ...
                        <div class="tab-content mt-4" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home">
                                <div class="row">
									...
									<?php $query=mysqli_query($con,"SELECT property.*, user.uname,user.utype,user.uimage FROM `property`,`user` WHERE property.uid=user.uid ORDER BY date DESC LIMIT 10");
                                        ...
                                        <div class="featured-thumb hover-zoomer mb-4">
                                            ...
                                            <div class="featured-thumb-data shadow-one">
                                                <div class="p-3">
                                                    ...
                                                    <span class="location text-capitalize"><i class="fas fa-map-marker-alt text-primary"></i> <?php echo $row['14'];?>&nbsp;<?php echo $row['15'];?>
                                                    &nbsp;&nbsp;&nbsp;PID::<?php echo $row['pid'];?></span> </div>
